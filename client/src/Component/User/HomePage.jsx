...
export default function HomePage() {
    return (
        <>
            <h1 className="flex justify-center items-center mt-20 text-3xl font-mono text-white">Welcome Back Hope You Find Solution To Your Problem</h1>
            <div className="h-screen m-5 flex flex-row justify-center items-center">
                <div>
