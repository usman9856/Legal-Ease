...
export default function SignupAdmin() {
    ...
    const Step3 = ({ onNext, country: initialCountry, city: initialCity }) => {
        ...
        // const [userType, setUserType] = useState(""); // State to store user's userType
    ...
    return (
        ...
        return (
            <center>
                <h1 className="m-10 p-10 text-3xl text-white min-h-screen">You do not have the right credential to access this point</h1>
            </center>
        )
    }
}
